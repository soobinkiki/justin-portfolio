        ...
        <div className="project_container" id="project">
            ...
            <div className="gif_container">
                ...
                <div className="gif">
                    ...
                    <div className="site_github_container">
                        <a href="https://github.com/soobinkiki/World_Soccer_League" target="_blank"><img id="githubIMG_2" src="/images/github.png" alt="GITHUB"></img></a>
                        <a className="livesite" href="https://world-soccer-league.herokuapp.com/" target="_blank">/  Live Site</a>
                    </div>
                ...
                <div className="gif">
                    ...
                    <div className="site_github_container">
                        <a href="https://github.com/soobinkiki/Numbers-Memory-Game" target="_blank"><img id="githubIMG_2" src="/images/github.png" alt="GITHUB"></img></a>
                        <a className="livesite" href="https://soobinkiki.github.io/" target="_blank">/  Live Site</a>
                    </div>
