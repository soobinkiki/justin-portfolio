...
export default function Contact () {
    ...
    return (
        <div className="text-center d-flex align-items-center justify-content-center contact_main_container" id="contact" >
            ...
            <a href="mailto:j.sb.parkk@gmail.com?subject=Hello!&body=If you are reading this? You need to give me a job opportunity :)" target="_blank" rel="noreferrer"><img id="email_logo" src={emailLogo} alt="email_logo"/></a>
        </div>
    )
}